package com.today.covid_19puntoscriticos.Slides;
 ...
 */
public class PollSlideActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_poll_slide);

        mVisible = true;

        mContentView =(ImageView) findViewById(R.id.gif);
        btn = (Button) findViewById(R.id.btn_next_sp);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(PollSlideActivity.this, Poll.class);
                startActivity(i);
            }
        });
    }
